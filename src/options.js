...
function App() {
  return (
    <Container>
      ...
      <Setting node='warnOnNewLoginPage' text='Warn me when I visit a login page for the first time.' />
      <Setting node='warnOnEveryLoginPage' text='Warn me every time I visit a login page.' />
    </Container>
  )
}
